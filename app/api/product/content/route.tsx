...
export async function PUT(req: Request) {
  try {
    const content: ProductContent = await req.json();

    const errorValidation = await productValidation.updateContent(req, content);
    ...
    const result = await productService.putContent(content);
